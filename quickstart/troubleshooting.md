...
##  Diskpool error resolution 

The below errors may be encountered while uprading from older releases to Mayastor 2.4 release and above. Use the following commands for resolution: 
