...
**K8s Events:**
The archive files generated by the supportability tool contain information on all the active events of the Kubernetes cluster present in the same namespace as Mayastor.
